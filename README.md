...
### Check Website: https://snossyecommerce.000webhostapp.com/
...
In this project:
- I have employed HTML, CSS, Bootstrap, JavaScript, jQuery, Xano for backend services, and Stripe for payment processing.
